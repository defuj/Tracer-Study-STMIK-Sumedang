...
/* harmony import */ var _chart_Pie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chart/Pie */ "./resources/js/pages/chart/Pie.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "Dashboard",
  components: {
    PieChart: _chart_Pie__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  data: function data() {
    return {
      dataAlumni: ""
  ...
  watch: {
    dataAlumni: function dataAlumni() {
  ...
  methods: {
    nama: function nama() {
      ...
      axios.get("/api/getAlumni").then(function (res) {
        _this.dataAlumni = res.data;
      })["catch"](function (err) {
        console.error(err);
      });
    },
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "row shadow-lg rounded-lg" }, [
        _c("div", { staticClass: "col-12 col-md-4 " }, [
          _c(
            "div",
            {
              staticClass:
                "card shadow-lg total-alumni text-white p-4 h4 font-weight-normal d-flex align-items-center "
            },
            [_vm._v("\n                    JUMLAH ALUMNI\n                ")]
          ),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "card show-lg p-4 d-flex align-items-center h4" },
            [
              _vm._v(
                "\n                    " +
                  _vm._s(_vm.dataAlumni.Alumni) +
                  "\n                "
              )
            ]
          ),
          ...
          _c(
            ...
            {
              staticClass:
                "mt-4 card shadow-lg mengisi-alumni text-white p-4 h4 font-weight-normal d-flex align-items-center"
            },
            [
              _vm._v(
                "\n                    ALUMNI YANG MENGISI\n                "
          ...
          _c(
            ...
            {
              staticClass:
                "mt-4 card shadow-lg belum-alumni text-white p-4 h4 font-weight-normal d-flex align-items-center"
            },
            [
              _vm._v(
        ...
        _c(
          ...
          {
            staticClass:
              "col-12 col-md-8 d-flex justify-content-center align-items-center",
            staticStyle: { "margin-right": "-100px" }
          },
          [
            _c("PieChart", {
              attrs: { data: _vm.dataAlumnis(), option: _vm.optionAlumnis() }
            })
          ],
          1
        )
...
/***/ "./resources/js/pages/chart/Pie.js":
/*!*****************************************!*\
  !*** ./resources/js/pages/chart/Pie.js ***!
  \*****************************************/
/*! exports provided: default */
